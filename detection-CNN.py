...
if __name__ == "__main__":
    ...
    X_train, X_validation, X_test, y_train, y_validation, y_test, class_names= prepare_datasets(0.15, 0.15)
    ...
    # output file
    model.save("model-d.h5", save_format='h5')
